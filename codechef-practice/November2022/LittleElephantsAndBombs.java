// https://www.codechef.com/submit/LEBOMBS
...
class LittleElephantsAndBombs  {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new LittleElephantsAndBombs().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new LittleElephantsAndBombs().run();
    }
