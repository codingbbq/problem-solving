// https://www.codechef.com/submit/AMMEAT
...
class AndrewAndMeatballs {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new AndrewAndMeatballs().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new AndrewAndMeatballs().run();
    }
