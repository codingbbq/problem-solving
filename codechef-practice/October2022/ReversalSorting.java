// https://www.codechef.com/submit/REVSORT
// Reversal Sorting
...
class ReversalSorting  {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new ReversalSorting().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new ReversalSorting().run();
    }
