...
class ExpertSetter {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new ExpertSetter().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new ExpertSetter().run();
    }
