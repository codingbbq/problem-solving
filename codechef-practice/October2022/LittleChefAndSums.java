// https://www.codechef.com/submit/CHEFSUM
...
class LittleChefAndSums {
    ...
    void solve(int TC) throws Exception {
        ...
        int num = Integer.MAX_VALUE; int index = 0;
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new LittleChefAndSums().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new LittleChefAndSums().run();
    }
