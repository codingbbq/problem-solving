// https://www.codechef.com/submit/ANTIPAL
// Chef and Pal
...
class ChefAndPal  {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new ChefAndPal().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new ChefAndPal().run();
    }
