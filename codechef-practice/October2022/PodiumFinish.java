// https://www.codechef.com/OCT221C/problems/PODIUM
// Podium Finish
...
class PodiumFinish {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new PodiumFinish().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new PodiumFinish().run();
    }
