// https://www.codechef.com/OCT221C/problems/BUILDINGRACE
// Building Race
...
class BuildingRace {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new BuildingRace().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new BuildingRace().run();
    }
