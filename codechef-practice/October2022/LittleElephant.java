// https://www.codechef.com/submit/LEPERMUT
...
class LittleElephant {
    ...
    void solve(int TC) throws Exception {
        ...
        println(inversion == localInversion ? "YES" : "NO");
    }
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new LittleElephant().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new LittleElephant().run();
    }
