// https://www.codechef.com/submit/SPLITIT
// Split the Str Ing
...
class SplitTheString {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new SplitTheString().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new SplitTheString().run();
    }
