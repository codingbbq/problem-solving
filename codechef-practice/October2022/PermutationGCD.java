// https://www.codechef.com/submit/PERMGCD?tab=statement
// Permutation GCD
...
class PermutationGCD  {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new PermutationGCD().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new PermutationGCD().run();
    }
