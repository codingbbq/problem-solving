// https://www.codechef.com/submit/AVGARR
// Average Array
...
class AverageArray {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new AverageArray().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new AverageArray().run();
    }
