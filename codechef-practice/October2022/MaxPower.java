// https://www.codechef.com/submit/MAX2
// Max power
...
class MaxPower  {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new MaxPower().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new MaxPower().run();
    }
