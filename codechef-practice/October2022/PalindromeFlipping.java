...
class PalindromeFlipping {
    ...
    void solve(int TC) throws Exception {
        ...
        println(one % 2 == 0 || zero % 2 == 0 ? "YES" : "NO");
    }
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new PalindromeFlipping().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new PalindromeFlipping().run();
    }
