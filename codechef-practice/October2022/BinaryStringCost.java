// https://www.codechef.com/submit/BSCOST
// Binary String Cost
...
class BinaryStringCost {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new BinaryStringCost().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new BinaryStringCost().run();
    }
