...
class Starters59SuspenseString {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new Starters59SuspenseString().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new Starters59SuspenseString().run();
    }
