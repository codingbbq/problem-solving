// https://www.codechef.com/submit/HOTEL?tab=statement
// Hotel Bytelandia
...
class HotelByteLandia {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new HotelByteLandia().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new HotelByteLandia().run();
    }
