// https://www.codechef.com/submit/RD19
// Minimum Deletions
...
class MinimumDeletions {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new MinimumDeletions().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new MinimumDeletions().run();
    }
