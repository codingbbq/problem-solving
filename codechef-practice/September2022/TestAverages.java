// https://www.codechef.com/submit/TESTAVG
// Test Averages
...
class TestAverages {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new TestAverages().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new TestAverages().run();
    }
