// https://www.codechef.com/submit/COUPON2
// Chef and Coupon
...
class ChefAndCoupon {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new ChefAndCoupon().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new ChefAndCoupon().run();
    }
