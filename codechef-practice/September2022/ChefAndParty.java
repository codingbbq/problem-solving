// https://www.codechef.com/submit/CHFPARTY
// Chef and Party
...
class ChefAndParty {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new ChefAndParty().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new ChefAndParty().run();
    }
