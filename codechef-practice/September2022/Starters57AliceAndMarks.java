...
public class Starters57AliceAndMarks {

    void solve(int TC) throws Exception {
        int x = ni(), y = ni();
        println((x >= 2*y) ? "Yes" : "No");
    }
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new Starters57AliceAndMarks().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new Starters57AliceAndMarks().run();
    }
