// https://www.codechef.com/START55C/problems/FEVER
// Fever
...
class ChefFever {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new ChefFever().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new ChefFever().run();
    }
