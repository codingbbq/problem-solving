// https://www.codechef.com/submit/MINORMAX
// Minimum or Maximum
...
class MinimumOrMaximum {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new MinimumOrMaximum().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new MinimumOrMaximum().run();
    }
