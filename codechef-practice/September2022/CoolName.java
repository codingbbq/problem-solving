// https://www.codechef.com/submit/CALPOWER
// Cool Name
...
class CoolName {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new CoolName().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new CoolName().run();
    }
