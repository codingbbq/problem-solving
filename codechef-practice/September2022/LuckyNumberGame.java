...
class LuckyNumberGame {
    ...
    void solve(int TC) throws Exception {
        int N = ni(), a = ni(), b = ni(); // Get the inputs
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new LuckyNumberGame().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new LuckyNumberGame().run();
    }
