// https://www.codechef.com/START54C/problems/TCKTFINE
// Ticket Fine
...
class TicketFine {
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new TicketFine().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new TicketFine().run();
    }
