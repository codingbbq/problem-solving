...
public class CheckYes {
    ...
    void solve(int TC) throws Exception {
        String s = ns();
        println(s.toLowerCase().equals("yes") ? "YES" : "NO");
    }
    ...
    public static void main(String[] args) throws Exception{
        if(memory) new Thread(null, new Runnable() {public void run(){try{new CheckYes().run();}catch(Exception e){e.printStackTrace();}}}, "1", 1 << 28).start();
        else new CheckYes().run();
    }
